...
require_once 'models/LoginMo/User.php';
...
class UserController
{
    ...
    public function login()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                include 'views/Login/login.php'; // Muestra la vista de inicio de sesión
            }
        } else {
            include 'views/Login/login.php'; // Muestra la vista de inicio de sesión si no es un POST
        }
    }
    ...
    public function changePassword()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            include 'views/Login/change_password.php'; // Muestra la vista para cambiar contraseña si no es un POST
        }
    }
    ...
    public function editUser()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            include 'views/Login/edit_user.php'; // Muestra la vista para editar información del usuario
        }
    }
