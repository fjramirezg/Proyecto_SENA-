...
require_once 'models/ProveedoresMo/SupplierModel.php';
...
class SupplierController
{
  ...
  public function add()
  {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      include 'views/Proveedores/add_supplier.php';
    }
  }
  ...
  public function edit($id)
  {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      include 'views/Proveedores/edit_supplier.php';
    }
  }
  ...
  public function list()
  {
    ...
    include 'views/proveedores/list_suppliers.php';
  }
}
